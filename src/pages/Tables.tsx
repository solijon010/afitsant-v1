...
export default function TablesPage(): JSX.Element {
  ...
  return (
    <div className="flex h-full flex-col" style={{ background: '#482020' }}>
      ...
      {/* ── Area tabs ── */}
      {areas.length > 1 && (
        <nav className="flex shrink-0 items-center gap-2 overflow-x-auto px-6 py-3" style={{ background: '#482020', borderBottom: '1px solid rgba(255,255,255,0.15)' }}>
          {areas.map((area) => {
      ...
      {/* ── Stollar ── */}
      <main className="flex-1 overflow-y-auto px-6 py-6" style={{ background: '#482020' }}>
        {areas.length === 0 ? (
